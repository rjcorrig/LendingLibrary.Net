...
namespace LendingLibrary.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Details(string id)
        {
            ...
            // Is this my account or a confirmed friend's account?
            var currentId = User.Identity.GetUserId();
            var currentUser = await UserManager.FindByIdAsync(currentId);

            ViewBag.FullDetails = (currentId == id) || (account.GetFriendshipStatusWith(currentUser) == FriendshipStatus.Approved);
